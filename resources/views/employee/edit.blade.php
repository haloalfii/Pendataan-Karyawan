...
@section('content')
    ...
    <div class="col-lg-5">
        <form method="POST" action="/employees/{{ $employees->id }}" class="mb-5">
            @method('put')
            @csrf
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    is-invalid
                @enderror" id="name"
                    name="name" autofocus value="{{ old('name', $employees->name) }}">
            ...
            <div class="mb-3">
                ...
                <select class="form-select form-control" name="company_id">
                    @foreach ($companies as $company)
                        @if (old('company_id', $employees->company_id) == $company->id)
